...
var emptyFunction = __webpack_require__(/*! fbjs/lib/emptyFunction */ 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_PayTypeSelector___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_PayTypeSelector__);
...
document.addEventListener('turbolinks:load', function () {
	...
	__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_PayTypeSelector__["default"], null), element);
});
...
throw new Error("Module build failed: SyntaxError: c:/Ruby/msys64/home/project/app/javascript/PayTypeSelector/index.jsx: JSX value should be either an expression or a quoted JSX text (34:20)\n\n  32 | \t\t\t\t\t<select id=\"pay_type_id\" onChange={this.onPayTypeSelected} name=\"order[pay_type_id]\">\n  33 | \t\t\t\t\t\t<option value=\"\">{I18n.t(\"orders.form.pay_prompt_html\")}</option>\n> 34 | \t\t\t\t\t\t<option value=1>{I18n.t(\"orders.form.pay_types.check\")}</option>\n     | \t\t\t\t\t\t              ^\n  35 | \t\t\t\t\t\t<option value=2>{I18n.t(\"orders.form.pay_types.credit_card\")}</option>\n  36 | \t\t\t\t\t\t<option value=3>{I18n.t(\"orders.form.pay_types.purchase_order\")}</option>\n  37 | \t\t\t\t\t</select>\n");

/***/ })
/******/ ]);
//# sourceMappingURL=pay_type-4d02231ee70210bc47e1.js.map