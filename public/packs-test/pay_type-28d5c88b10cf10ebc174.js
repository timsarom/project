...
throw new Error("Module build failed: SyntaxError: c:/Ruby/msys64/home/project/app/javascript/PayTypeSelector/index.jsx: super() outside of class constructor (10:2)\n\n   8 | class PayTypeSelector extends React.Component {\n   9 | \tonPayTypeSelected(event) {\n> 10 | \t\tsuper(props);\n     | \t\t^\n  11 | \t\tthis.onPayTypeSelected = this.onPayTypeSelected.bind(this);\n  12 | \t\tthis.state = { selectedPayType: null };\n  13 | }\n");

/***/ })
/******/ ]);
//# sourceMappingURL=pay_type-28d5c88b10cf10ebc174.js.map